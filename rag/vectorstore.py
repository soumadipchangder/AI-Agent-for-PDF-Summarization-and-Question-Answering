...
class VectorStoreManager:
    ...
    def __init__(self, embeddings: Embeddings, persist_directory: str = "faiss_index"):
        ...
        if os.path.exists(self.persist_directory):
            ...
            try:
                ...
                print(f"Fail to load vectorstore: {e}. Starting fresh.")
                self.vectorstore = None
                
    def add_documents(self, documents: List[Document]):
        """
        Adds new documents to the vectorstore and persists it to disk.
        """
        if not documents:
            return
        ...
        if self.vectorstore is None:
            ...
            print(f"Adding {len(documents)} to existing vectorstore...")
    ...
    def get_retriever(self, search_kwargs: dict = {"k": 4}):
        """
        Returns a base retriever object from the vector store.
        """
        if self.vectorstore is None:
